...
class AssignFirstGradeWorkshopsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'overrides.*.workshop_id' => ['required_with:overrides', 'integer', 'min:1'],
            'warn_gh_mismatch' => ['sometimes', 'boolean'],
        ];
    }
}
