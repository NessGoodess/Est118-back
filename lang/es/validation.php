...
return [
    ...
    | Puedes ajustar cada uno de estos mensajes aquí.
    |
    */
    ...
    'attributes' => [
        ...
        // Email
        'email.contactEmail' => 'correo electrónico de contacto',

        // Datos del aspirante
        'applicantInfo.firstName' => 'nombre',
        'applicantInfo.lastName' => 'primer apellido',
        'applicantInfo.secondLastName' => 'segundo apellido',
        'applicantInfo.curp' => 'CURP',
        'applicantInfo.birthDate' => 'fecha de nacimiento',
        'applicantInfo.age' => 'edad',
        'applicantInfo.gender' => 'género',
        'applicantInfo.phone' => 'teléfono',
        'applicantInfo.studentEmail' => 'correo electrónico del estudiante',
        'applicantInfo.placeOfBirth' => 'lugar de nacimiento',

        // Información académica
        'academicInfo.previousSchool' => 'escuela de procedencia',
        'academicInfo.currentAverage' => 'promedio actual',
        'academicInfo.hasSiblings' => 'tiene hermanos',
        'academicInfo.siblingsDetails' => 'detalles de hermanos',

        // Dirección
        'addressInfo.streetType' => 'tipo de calle',
        'addressInfo.streetName' => 'nombre de la calle',
        'addressInfo.houseNumber' => 'número exterior',
        'addressInfo.unitNumber' => 'número interior',
        'addressInfo.neighborhoodType' => 'tipo de colonia',
        'addressInfo.neighborhoodName' => 'nombre de la colonia',
        'addressInfo.postalCode' => 'código postal',
        'addressInfo.city' => 'ciudad',
        'addressInfo.state' => 'estado',

        // Tutor
        'guardianInfo.guardianFirstName' => 'nombre del tutor',
        'guardianInfo.guardianLastName' => 'apellido del tutor',
        'guardianInfo.guardianSecondLastName' => 'segundo apellido del tutor',
        'guardianInfo.guardianCurp' => 'CURP del tutor',
        'guardianInfo.guardianPhone' => 'teléfono del tutor',
        'guardianInfo.guardianRelationship' => 'parentesco',

        // Talleres
        'workshopSelect.workshopFirstChoice' => 'primer taller',
        'workshopSelect.workshopSecondChoice' => 'segundo taller',
